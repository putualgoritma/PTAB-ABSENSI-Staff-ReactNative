...
if(!loading1){
  ...
  return (
    <View style={styles.container} ref={viewToSnapshotRef} >
      <RNCamera
        ref={ref => {
          camera = ref;
        }}
      ...
      >
        <Text>Tessssssssss</Text>
      </View>
      <View style={{ marginTop : -100 }}><Text>tesssdfgghj</Text></View>
...
{/* <TouchableOpacity onPress={takePicture.bind(this)} style={btnAble ?  styles.captureF : styles.capture }  disabled={btnAble}> */}
