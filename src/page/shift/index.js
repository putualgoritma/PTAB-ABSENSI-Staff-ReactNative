...
const handleConfirm2 = (date) => {
  ...
  const resetData = () =>{
    ...
    API.absenceHistory("", "").then((result) => {
        ...
        return (
          <View style={{ flex : 1 }}>
            ...
            {/* <TouchableOpacity style={styles.date} onPress={showDatePicker} ><Text style={styles.btnText}>{date}</Text></TouchableOpacity>
                            ...
                            /> */}
              <TouchableOpacity style={[styles.btn, {backgroundColor : '#e6bc15'}]} onPress ={()=>{navigation.navigate('ChangeShift', {name : "Pilih Staff", id : ""})}}>
      ...
      <Text style={[{fontSize : 16, fontWeight : 'bold', color : '#000000', marginVertical : windowHeight*0.01}]}>Menunggu Konfirmasi</Text>
